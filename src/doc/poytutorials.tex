...
\section{Traditional maximum likelihood analysis with static characters}{\label{tutorial 9}}
...
\poycommand{tcm} specified for this import is non-metric, but consistent with the assumption of indels as 
...
\item \texttt{swap(spr,optimize:(model:(max\_count:5)))} This command swaps the tree using subtree pruning and 
