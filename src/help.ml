...
“Sys_error (“No such file or directory”)”. read automatically detects the type of the 
...
the first will be chosen. Any tilde (“∼”) symbols in the data file will be ignored. read(custom_alphabet:(\"CA_run1\",tcm:(\"alphabet\"),level:2,
tiebreaker:last)) 
