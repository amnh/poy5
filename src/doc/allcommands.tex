...
reporting trees for other analysis, the new trees are going to be
appended. Alternatively, trees from different builds can be redirected
...
branches collapsed. All the arguments of \poycommand{calculate\_support}
...
the Hennig86 format can be generated based on an implied alignment
...
format on screen or in the PDF format if redirected to a file.
The optional \poylident is \poyargument{collapse} 
(see~\nccross{collapse}{collapse}).}
{graphtrees}
