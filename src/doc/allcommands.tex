...
\begin{command}{read}{}
 ...
 \argumentdefinition{custom\_alphabet}{\obligatory\poystring list,cm\obligatory \poystring,{\optionall {{init3d{\obligatory \poybool},tiebreaker{\obligatory \poylident},orientation:\poybool})}}}
	...
	\smallskip
	Three optional arguments of \poyargument{custom\_alphabet} are possible: \poyargument{init3d}; 
	\poyargument{tiebreaker}; and \poyargument{orientation}.  Both \poyargument{init3d} and 
	...
	that can lead to a lot of memory consumption.  \poyargument{tiebreaker} 
	
	\poycommand{custom\_alphabet} can be transformed into \poycommand{breakinv} using \poycommand{transform}.}
	 {customalphabet}
