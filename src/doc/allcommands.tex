\begin{command}{build}{buildcommand}
	...
	\begin{arguments}
        ...
        \argumentdefinition{random}{}
            {Generates a tree at random to diagnose. All possible trees have equal probability.}
            {buildrandom}
	...
	\end{statement}
        ...
        \begin{argumentgroup}{Likelihood transformation methods}
            ...
            \argumentdefinition{model}{}
                ...
                \begin{description}
                    ...
                    \argumentdefinition{jc69/neyman}{}
                        ...
                        forced to be equal. This model will work for any size
                        alphabet.}
                        {jc69}

                    \argumentdefinition{f81}{}
                        {The model of Felsenstein \cite{felsenstein1981}. A
                    ...
                    \argumentdefinition{f84}{}
                        {The model of Felsenstein \cite{felsenstein1980}. Rates
            ...
            \argumentdefinition{rates}{}
                ...
                variation are the discreet gamma distribution ($\Gamma$)
                \cite{yang1994a} and this distribution with an additional
                invariable rate class, the theta distribution ($\Theta$)
                ...
                \argumentdefinition{priors}{}
                    ...
                    \begin{description}
                        ...
                        \argumentdefinition{estimate}{}
                            ...
                            sequences, $\pi_{gap} = \frac{\sum_{i=0}^n
                            |S_{\hat{i}}| - |S_i|}{n |S_{\hat{i}}|}$, where
