...
sequences. Alternatively, the argument of \poyargument{auto\_sequence\_partition} of the command \ccross{transform}. 
...
account gap extension cost. For rationale for using this cost regime see Frost et al. \cite{frost2001} %and for other examples of its application see.
\item[Homology maximization] This approach, developed by De Laet \cite{delaet2005}, assigns costs 
\texttt{2, 3, and 1} to transformations, gap opening, and gap extension respectively. %For examples using this methods see
...
incongruence is selected as optimal. %For examples using this methods see
\end{description}
