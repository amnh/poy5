...
/* $Id: init.c 2 2004-06-22 15:40:20Z andres $ */
...
value caml_mpi_init(value arguments)
{
  ...
  /* Modified by Andres Varon to handle the modification of the program
   * parameters and pass it back to Ocaml. */
  
  return (copy_string_array (argv));
}
