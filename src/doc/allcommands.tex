 ...
 \setlength{\parindent}{0.5cm}                                
	...
	\begin{arguments}
       ...
       \argumentdefinition{chromosome}{\obligatory{(\poystring list)}}
            ...
            \argumentdefinition{custom\_alphabet}{\obligatory \poystring list,cm\obligatory \poystring,{\optionall {{init3d{\obligatory \poystring},tiebreaker{\obligatory \poystring},orientation:\poybool})}}}
