...
\begin{command}{perturb}{}
	...
	\begin{arguments}
        ...
        \argumentdefinition{ratchet}{\optional{(\poyfloat, \poyint)}}
            ...
            Under default settings, \poyargument{ratchet} selects 25 percent of
            characters and upweights them by a factor of 2.  Unless
            \poyargument{ratchet} is performed under default settings (that does
            not require the specification of the fraction of data to be
            reweighted and the severity value), both values must be specified in
            the proper order and separated by a comma.  This argument is only
            used as an argument for \poycommand{perturb}.}
            {}

        \argumentdefinition{resample}{\obligatory{(\poyint)}}
            {Resamples the data characters in random order with replacement. The
            \poyargument{resample} string consists of an integer value
            specifying the number of items to be resampled. No default settings
            are available for \poyargument{resample}. This command is only used
            as an argument of \poycommand{perturb}.}
            {}
    ...
    \poydefaults{ratchet:(0.25,2), swap (trees:1), iterations:1}
	...
	\begin{poyexamples}
        ...
        \poyexample{perturb(resample:(50), iterations:10)}
            ...
            percent of characters with replacement. Branch swapping is performed
        ...
        \poyexample{perturb(iterations:20, ratchet:(0.18,3))}
            ...
            performed using alternating SPR and TBR, and keeping one optimal tree
            (the default of \poycommand{swap}).}

        \poyexample{perturb(iterations:1, transform (tcm:(4,3)))}
            {Transforms the cost regime of all applicable characters (\emph{i.e.}
            ...
            Subsequently a single round of branch swapping is performed using
            alternating SPR and TBR, and and keeping one optimal tree (the default
            of \poycommand{swap}).}
        ...
        \poyexample{perturb(transform(static\_approx), ratchet:(0.2,5), iterations:25, swap(tbr, trees:5))}
            {Transforms all applicable (\emph{i.e.} dynamic homology sequence
...
\begin{command}{read}{}
	...
	\begin{arguments}
        ...
        \argumentdefinition{breakinv}{\obligatory{(STRING, STRING, [orientation:\poybool])}}
	...
	can be transformed into \poycommand{breakinv} using \poycommand{transform}.}
	 {customalphabet}
        ...
        tcm:(\poyint, \poyint) [,gap\_opening:\poyint])}}
            ...
            \poyargument{tcm} and \poyargument{gapopening} arguments. (See the 
            argument~\nccross{tcm}{transformtcm} 
            of the command \poycommand{transform}.)}
            {prealigned2}
	...
	\poyexample{report("filename", trees:(collapse:false, newick))} 
        ...
        reports on the data, diagnosis, and strict consensus and 75 percent
         ...
         characters on screen.}
          ...
          \poyexample{report("scipt1\_analysis", script\_analysis:"/users/data files/\\script1.poy")}
...
%           \argumentdefinition{partition}{\obligatory{\poyint}}
%                {Specifies the lapse of time in seconds that should have passed
%                between reporting the total execution time of a swap and build
%                command. If the timer is set to 0, then no time messages are
%               generated.}{}
        ...
        \begin{argumentgroup}{Likelihood Optimization}
            ...
            \argumentdefinition{opt:coarse[:NUM]}{}
            ...
            \argumentdefinition{opt:exhaustive[:NUM]}{}
        ...
        \begin{argumentgroup}{Cost calculation}
            ...
            exclusive: only the argument of \poycommand{set} specified last is
            used.}
            ...
            \argumentdefinition{exhaustive\_do}{}
                ...
                with \poyargument{normal\_do} is
    ...
    \poydefaults{history:1000, normal\_do}
...
\begin{command}{swap}{swapcommand}
	...
	\begin{arguments}
        ...
        \begin{argumentgroup}{Likelihood Optimization}
            ...
            available in the \poycommand{build()} and \poycommand{fuse()}
...
\begin{command}{transform}{transformcommand}
	...
	\begin{arguments}
        ...
        \poyargument{randomizeterminals}}
        {alphabeticterminals}
     ...
     \argumentdefinition{do}{}
      ...
      \argumentdefinition{level}{\obligatory{(\poyint}, \poylident)}
        ...
        build or search. See the description of the argument \poyargument{alphabeticterminals}}
        {randomizeterminals}
	...
	\end{statement}
            ...
            the cost of an indel set to \texttt{2} (\poyargument{tcm:(1,1)}).]}
            {transformtcm}
	...
	\end{statement}
        ...
        \begin{argumentgroup}{Likelihood transformation methods}
            ...
            \argumentdefinition{likelihood}{\obligatory{(model,rates,priors,gap,cost,alphabet)}}
            ...
            \argumentdefinition{elikelihood}{\obligatory{(model,rates,priors,gap,cost,alphabet)}}
                {Transforms the specified characters to either static or dynamic
            ...
            \argumentdefinition{modelSelection}{}
                ...
                \begin{description}
                    ...
                    \argumentdefinition{aic:FILENAME}{}
                    ...
                    \argumentdefinition{aicc:FILENAME}{}
                    ...
                    \argumentdefinition{bic:FILENAME}{}
            ...
            \argumentdefinition{rates:(TYPE)}{}
                ...
                \argumentdefinition{priors:(TYPE)}{}
...
%                           % \end{statement}                         
                ...
                \argumentdefinition{alphabet:(TYPE)}{}
	   ...
	   \argumentdefinition{annotate}{\obligatory{(\poylident,\poyfloat,\poyfloat,\poyfloat,\poyfloat)}}
        ...
        [orientation:\poybool])}}
            ...
            \argumentdefinition{custom\_to\_breakinv}{\obligatory{([argument list])}}
                {Transforms \poyargument{custom\_alphabet} characters into the 
                \poyargument{breakinv} character type to allow for 
