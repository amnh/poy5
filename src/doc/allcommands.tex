...
{Performed during a likelihood search, this rediagnoses the tree, clearing the optimized 
model parameters and branch lengths.  Additional optimizations are performed after diagnosis.}
{clear}

\argumentdefinition{preserve}{}
{Performed during a likelihood search, this rediagnoses the tree, keeping the current model 
parameters and branch lengths. Additional optimizations are performed after diagnosis.}
{preserve}
        ...
        \begin{argumentgroup}{Application settings}
          ...
          \argumentdefinition{root}{\obligatory{\poylident}}
              ...
              \argumentdefinition{space\_saving\_alignment}{\optional{\poylident}}
                        ...
                        argument \poyargument{normal\_alignment} above.}
...
%               generated.}{}
	...
	\begin{statement}
	  ...
	  \nccross{diagnosis}{diagnosis}) of the command \poycommand{report} 
...
%                           % \end{statement}                         
                ...
                \argumentdefinition{alphabet:TYPE}{}
                    ...
                    define the alphabet size in the transform. Parsimony scores
                    do not add cost on unobserved states, but under likelihood
                    there can be an added cost. Here we allow someone to specify
                    the size of the alphabet, or use the minimum states that
                    would encompass all the observed states in the data.
