...
\begin{command}{read}{}
	...
	\begin{statement}
        ...
        [orientation:\poybool, init3D:\poybool, \poylident])}}
	...
	The default heuristic \texttt{level} is $2$.  This can be changed via the command \poycommand{transform}.
...
\begin{command}{transform}{transformcommand}
	...
	\end{statement}
        ...
        \argumentdefinition{trailing\_insertion}{\obligatory{\poystring /(\poyint list)}}
            ...
            Synonym of the argument \poyargument{ti}. This method is applicable only to 
        ...
        \argumentdefinition{trailing\_deletion}{\obligatory{\poystring /(\poyint list)}}
            ...
            cost of the indel of a gap (should be 0). Instead of a file, the list can
            be the input of the argument, in the same order, separated by commas.
            Synonym of the argument \poyargument{td}. This method is applicable only to 
            dynamic homology characters.} 
            {trailinginsertion}
...
%                           % \end{statement}
	...
	Concord TSP Solver available at \texttt{http://www.tsp.gatech.edu/concorde/}.
	 ...
	 \argumentdefinition{breakinv\_to\_custom}{}
            {Transforms \poyargument{breakinv} character type into \poyargument{custom\_alphabet} 	 
	...
	\begin{description}
            	...
            	\argumentdefinition{med\_approx}{\obligatory{\poybool}}
                        ...
                        {The optional \textt {newkkonen} argument can be used with chromosomal or genomic data to minimize memory 
		...
		%\end{figure}
      		     ...
      		     {Calculates the a cost for moving a sequence (locus) between non-homologus chromosomes (translocation).
                        ...
                        The default value of \poyargument{translocation} is \texttt{100}.} 
                        {translocation}

       
                   \begin{statement}
  		Note that the arguments \poyargument{locus\_breakpoint} and \poyargument 
		{chrom\_breakpoint} cannot be used simultaneously with the arguments 
		\poyargument{locus\_inversion} and \poyargument{chrom\_inversion}
 	        ...
 	        \argumentdefinition{circular}{\obligatory{\poybool}} 
		      ...
		      \argumentdefinition{median}{\obligatory{\poyint}}
               ...
               \argumentdefinition{median\_solver:}{\obligatory{\poylident}}
                       ...
                       \texttt {mgr} \cite{bourqueandpevzner2002}, \textt {vinh} \cite{vinh2006}, and \textt {chainedlk, simplelk}
                       from the Concord package \cite{http://www.tsp.gatech.edu/concorde/}. The
                       default median solver is \texttt {caprara}. Note: coe package is required for \textt {chainedlk} and \textt {simplelk}
	...
	\begin{poyexamples} 
		...
		\poyexample{transform(search\_based:(("mycustom\_char1.fas","mycustom\_extra1.fas"),("mycustom\_char2.fas","mycustom\_extra2.fas")))}
...
%          	\poyexample{transform((all, dynamic\_pam:(locus\_breakpoint:10, max\_kept\_wag:2, min\_rearrangement\_len:60, 
