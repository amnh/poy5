...
let () = SadmanOutput.register "Methods" "$Revision: 3649 $"
...
let opt_mode  : Numerical.opt_modes ref = ref (`Coarse (Some 2))
...
type report = [
    ...
    | `RootName of string
    | `RobinsonFoulds of string option
]
...
type script = [ 
    ...
    | `Repeat of (repeat_condition * script list)
