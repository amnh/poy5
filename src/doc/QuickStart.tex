...
and hardware configurations, including Mac OSX, Microsoft Windows XP, and Linux. %\poy \emph{binaries}
...
\begin{flushleft}
	...
	\end{minipage}
		\begin{itemize}
           ...
           \href{http://www-unix.mcs.anl.gov/mpi/}{MICH2}. 
           Note: The developers encountered problems when using MICH2 1.4.1.p1, therefore it is advised that the 
           user install MICH2 1.4, where no problems were encountered.
          \end{itemize}
...
This script will compile both the \emph{Graphical User Interface} and \emph{Interactive Console} or \emph{ncurses} 
