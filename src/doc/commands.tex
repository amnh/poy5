...
\include{version}
\author{\textbf {Program and Documentation} \\ Andr\'es Var\'on \\ Nicholas Lucaroni \\Lin Hong \\Le Sy Vinh \\ Illya Bomash \\ Ward C. Wheeler \\ \bigskip \textbf{Documentation} \\ Ilya T\"emkin \\ Megan Cevasco \\Louise M. Crowley \\ John S. S. Denton \\ Kurt M. Pickett \\ Juli\'an Faivovich \\ Taran Grant \\ William Leo Smith}
