...
val of_parser : cm -> ((Nexus.Parsed.static_state * int) array * int) -> int -> t * int
...
val min_possible_cost : int array array -> Nexus.Parsed.static_state list -> float

val max_possible_cost : int array array -> Nexus.Parsed.static_state list -> float
