	...
	\end{statement}
        ...
        \begin{argumentgroup}{Likelihood transformation methods}
            ...
            \argumentdefinition{model}{}
                ...
                employ globally homogeneous models (jayaswal 2005), which
                ...
                Parameters can be specifed by following the model name with a
                colon, left parenthesis, and a list of numbers for the
                particular model, followed by a closing parenthesis, (ie,
                k2p:(2.0) )
                ...
                \begin{description}
                    ...
                    \argumentdefinition{jc69/neyman}{}
                        {The model of Jukes and Cantor (1969) under nucleotide
                        data, or Neyman (1971) in general. A single rate
                    ...
                    \argumentdefinition{hky85}{}
                        {The model of Hasegawa (1984,1985). Three rate classes:
                    ...
                    \argumentdefinition{tn93}{}
                        {The model of Tamura and Nei (1993).  Three rate
                        classes: transversions (purine / pyrimidine), and
            ...
            \argumentdefinition{rates}{}
                ...
                distribution ($\Theta$). This is only useful for more then two
                taxa.
                
                \begin{statement}
                    Under MAL the rates are naturally averaged across the
                    discreete distribution, while under MPL we select the best
                    rate class for the assignment of each character. Because
                    dynamic likelihood characters alignment matrix would select
                    one rate class for alignment and this is equivlent to a
                    constant muliplication of the branch length, dynamic mpl
                    characters do not support rate distribution. These are
                ...
                \begin{statement}
                    ...
                    values inferred are correlated (Sullivan, 1999).  It has
                ...
                \argumentdefinition{priors}{}
                    ...
                    \begin{description}
                        ...
                        \argumentdefinition{equal}{}
                            ...
                            $\frac{1}{a}$, where $a$ is the character alphabet size.}
                            {equal}
                        ...
                        \argumentdefinition{estimate}{}
                            ...
                            \frac{\sum_{i=0}^n |S_{\hat{i}}| - |S_i|}{n
                            |S_{\hat{i}}|}$, where
...
%                           % \begin{statement}
%                           %     We use a smoothing function for the maximum
...
%                           % \end{statement}
                ...
                \argumentdefinition{gapmode}{}
                    ...
                    indels on static likelihood characters follows McGuire et
                    al. (2001), but expands the implementation outside the F84
                    ...
                    models are scarce, but see Rivas and Eddy (2008), Redelings
                    and Suchard (2005, 2007) for alternative parameterizations,
                    and Liu et al. (2009) for an iterative approximation of
