...
\begin{command}{search}{}
	...
	\begin{poydescription}
            ...
            thorough search. The command integrates \poycommand{build},
...
\begin{command}{select}{}
	...
	\begin{poydescription} 
            Specifies a subset of terminals, characters, and trees from those
	...
	\end{statement}
            ...
            \argumentdefinition{terminals}{}
                {Specifies that subsequently listed identifiers
