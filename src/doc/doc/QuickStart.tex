...
\poy installers for Linux, Windows XP, and Mac OSX, source code, and documentation in PDF format are available from the \poy Download website at the American Museum of Natural History Computational Sciences: \hl{library website?}
...
\setlength{\itemindent}{0pt}%
	...
	and whether these data types should be treated as prealigned (if possible).  Qualitative 
	data are any non-sequence, prealigned data type (e.g. morphological, behavioral).  
	These character types are optimized as additive, non-additive or Sankoff characters.  
	This information should be found in the data file.
    \item[Sequence Parameters]
        ...
        \begin{itemize} 
        		\item \textbf{Break Inversion Parameters} Holds a drop down menu wherein the user specifies
		...
		\item \textbf{Qualitative Parameters}
	\end{itemize}
