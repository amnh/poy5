...
\include{version}
\author{\textbf {Program and Documentation POY 5.0} \\ Andr\'es Var\'on \\ Nicholas Lucaroni \\Lin Hong \\Ward C. Wheeler \\ \bigskip \textbf{Documentation POY 5.0} \\Louise M. Crowley \\ John S. S. Denton \\ Megan Cevasco }

\include{version}
\author{\textbf {Program and Documentation POY 4.0} \\ Andr\'es Var\'on \\ Nicholas Lucaroni \\Lin Hong \\Le Sy Vinh \\ Illya Bomash \\ Ward C. Wheeler \\ \bigskip \textbf{Documentation POY 4.0} 
...
{\it
Ilya T\"emkin} \\
\hl{Northern Virginia Community College}\\
\smallskip
{\it
Illya Bomash}\\
